...
class RegistrationController extends Controller
{
    ...
    public function actionRegister()
    {
        ...
        $rol = null;
        if(null !== (\Yii::$app->request->post('Rol')))
                   $rol = \Yii::$app->request->post('Rol');
            
        if ($model->load(\Yii::$app->request->post()) && $model->register($rol)) {
    ...
    public function actionConnect($account_id)
    {
        ...
        {
            $datos = json_decode($account['data']);
        ...
        if ($user->load(\Yii::$app->request->post()) && $user->create($rol)) {
